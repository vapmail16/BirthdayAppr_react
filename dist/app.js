...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Initialize UI object first
    const UI = {
        form: safeGetElement('userForm'),
        status: safeGetElement('status'),
        tabs: safeQueryAll('.tab-btn'),
        ...
        settingsModal: safeGetElement('settingsModal'),
        cancelSettings: safeGetElement('cancelSettings'),
        closeSettings: safeGetElement('closeSettings'),
        settingsTabs: safeQueryAll('.settings-tab'),
        settingsSections: safeQueryAll('.settings-section'),
    };
